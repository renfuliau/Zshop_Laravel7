                    ...
                    <div class="shop-sidebar">
                        ...
                        <div class="single-widget category">
                            ...
                            <ul class="categor-list">
                                ...
                                <li><a
                                        href="{{ route('zshop-productlist-category', ['slug' => $cat_info->slug, 'title' => $cat_info->title]) }}">{{ $cat_info->title }}</a>
                                    <ul>
                                        @foreach ($cat_info->child_cat as $sub_menu)
                                            <li><a
                                                    href="{{ route('zshop-productlist-subcategory', ['slug' => $cat_info->slug, 'sub_slug' => $sub_menu->slug, 'title' => $cat_info->title, 'subtitle' => $sub_menu->title]) }}">{{ $sub_menu->title }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
